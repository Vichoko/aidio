...
RNN1D_WEIGHT_DECAY = 0.000001
RNN1D_DOWNSAMPLER_OUT_CHANNELS = 256
RNN1D_DOWNSAMPLER_KERNEL_SIZE = 32
...
# Conv1D Classifier
CONV1D_BATCH_SIZE = 4000
CONV1D_LEARNING_RATE = 0.01
CONV1D_WEIGHT_DECAY = 0.0000001
CONV1D_FEATURE_DIM = 1024
CONV1D_STRIDE = 2
CONV1D_KERNEL_SIZE = 64
CONV1D_DILATION = 1
# FC
...
WNTF_TRANSFORMER_D_MODEL = 256
WNTF_TRANSFORMER_N_LAYERS = 3
WNTF_TRANSFORMER_DIM_FEEDFORWARD = 256
# FC
...
# WaveNetLSTM
# WN
WNLSTM_BATCH_SIZE = 12
WNLSTM_WAVENET_LAYERS = 5
WNLSTM_WAVENET_BLOCKS = 5
