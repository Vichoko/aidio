...
# WaveNet
# Insights: Deeper was worse.
WAVENET_LAYERS = 2 ** 2
WAVENET_BLOCKS = 2 ** 3
WAVENET_DILATION_CHANNELS = 2 ** 3
WAVENET_RESIDUAL_CHANNELS = 2 ** 3
WAVENET_SKIP_CHANNELS = 2 ** 3
WAVENET_END_CHANNELS = 2 ** 6
WAVENET_CLASSES = 1
WAVENET_OUTPUT_LENGTH = 2
WAVENET_KERNEL_SIZE = 2 ** 4
WAVENET_EPOCHS = -1
WAVENET_BATCH_SIZE = 24
WAVENET_POOLING_KERNEL_SIZE = 2 ** 4
WAVENET_POOLING_STRIDE = 2 ** 3
